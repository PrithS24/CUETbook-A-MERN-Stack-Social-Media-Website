  ...
  const sponsers = [
    {
      name: "Gadgetry BD",
      description:
        "Your go-to destination for tech products and electronic gadgets.",
    ...
    },
    {
      name: "Kaya",
      description:
        "Unique handmade wooden jewelry and crafts crafted with love.",
